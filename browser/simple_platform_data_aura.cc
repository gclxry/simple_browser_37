...
SimplePlatformDataAura* SimpleWebContentsDelegate::platform_ = NULL;

SimplePlatformDataAura::SimplePlatformDataAura(const gfx::Size& initial_size) {
...
SimplePlatformDataAura::~SimplePlatformDataAura() {
}

void SimplePlatformDataAura::ShowWindow() {
  host_->Show();
}

void SimplePlatformDataAura::ResizeWindow(const gfx::Size& size) {
